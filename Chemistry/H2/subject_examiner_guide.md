...
# Subject Examiner's Guide — Chemistry H2

> **STATUS: NOT BUILT.** This is a placeholder.
> To build: ensure `inputs/Chemistry/H2/` has past papers + official docs + mark schemes/model answers,
...
> is **quantitative** (per-topic overrides allowed — see `system/subjects.md`).
