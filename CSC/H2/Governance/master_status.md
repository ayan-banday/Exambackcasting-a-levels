...
## Appendix: Content Node Map (Coverage Checklist)

Use this to track which official syllabus nodes have been tested at least once. Updated as clusters are generated and gaps are closed.

### 1A — General Characteristics
- [ ] 党国体制 (Party-state system)
- [ ] 意识形态与政绩合法性 (Ideological + performance legitimacy)
- [ ] 中央-地方关系 (Central-local relations)

### 1B — Governance Challenges
- [ ] 贪污和腐败 (Corruption)
- [ ] 法治与司法改革 (Rule of law / judicial reform)
- [ ] 回应人民诉求的能力 (Responsiveness to public demands)
- [ ] 少数民族问题 (Ethnic minority governance)
- [ ] 执政能力与机构改革 (Governing capacity / institutional reform)
- [ ] 政治参与与异见 (Political participation and dissent)

### 1C — Strategies and Effectiveness
- [ ] 反腐策略 (Anti-corruption strategies)
- [ ] 司法改革策略 (Judicial reform strategies)
- [ ] 公共服务与回应机制 (Public services + responsiveness mechanisms)
- [ ] 少数民族管理策略 (Ethnic minority governance strategies)
- [ ] 党和国家机构改革 (Party and state institutional reform)
- [ ] 政治参与管理 (Managing political participation)
